        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="bg-gray-100 p-3 rounded-md">
              ...
              <p className="text-xs text-gray-500">admin@luminacare.com</p>
              <p className="text-xs text-gray-500">senha123</p>
            </div>
            <div className="bg-gray-100 p-3 rounded-md">
              <p className="text-xs font-medium text-gray-700">Profissional</p>
              <p className="text-xs text-gray-500">carlos@luminacare.com</p>
              <p className="text-xs text-gray-500">senha123</p>
            </div>
          </div>
        </div>
